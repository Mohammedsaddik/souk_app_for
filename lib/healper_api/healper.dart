...
class Api
{
  Future<dynamic> get({required String url,String? token}) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('proplem with status code ${response.statusCode}');
    }
  }
  ...
  Future<dynamic> post({
    ...
    if(response.statusCode==200)
      ...
      throw Exception('proplem with status code ${response.statusCode}with body ${jsonDecode(response.body)}');
    }
  }
